...
CubeInsideOut::CubeInsideOut() {}

CubeInsideOut::CubeInsideOut(vec3 colorVec) {

    TexturedColoredVertex vertexArray[] = {  // position, color, normal, uv
            TexturedColoredVertex(vec3(-0.5f, 0.5f, 0.5f), colorVec, vec3(-1.0f, 0.0f, 0.0f), vec2(1.0f, 1.0f)), // left
            ...
            TexturedColoredVertex(vec3(-0.5f, 0.5f, -0.5f), colorVec, vec3(0.0f, 0.0f, -1.0f), vec2(0.0f, 1.0f)), // far
            ...
            TexturedColoredVertex(vec3(0.5f, -0.5f, -0.5f), colorVec, vec3(0.0f, -1.0f, 0.0f), vec2(1.0f, 0.0f)), // bottom
            ...
            TexturedColoredVertex(vec3(0.5f, -0.5f, 0.5f), colorVec, vec3(0.0f, 0.0f, 1.0f), vec2(1.0f, 0.0f)), // near
            TexturedColoredVertex(vec3(-0.5f, -0.5f, 0.5f), colorVec, vec3(0.0f, 0.0f, 1.0f), vec2(0.0f, 0.0f)),
            ...
            TexturedColoredVertex(vec3(0.5f, 0.5f, -0.5f), colorVec, vec3(1.0f, 0.0f, 0.0f), vec2(1.0f, 0.0f)), // right
            TexturedColoredVertex(vec3(0.5f, -0.5f, -0.5f), colorVec, vec3(1.0f, 0.0f, 0.0f), vec2(0.0f, 0.0f)),
            TexturedColoredVertex(vec3(0.5f, 0.5f, 0.5f), colorVec, vec3(1.0f, 0.0f, 0.0f), vec2(1.0f, 1.0f)),
            ...
            TexturedColoredVertex(vec3(-0.5f, 0.5f, -0.5f), colorVec, vec3(0.0f, 1.0f, 0.0f), vec2(0.0f, 0.0f)), // top
...
GLuint CubeInsideOut::getVertexBufferObject() {
